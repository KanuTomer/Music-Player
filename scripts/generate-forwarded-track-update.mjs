...
if (!migrationArgument || !docsArgument) {
  throw new Error(
    "Usage: node scripts/generate-forwarded-track-update.mjs <migration.sql> <song-list.md>",
  );
}
...
const groups = [
  {
    ...
    tracks: [
      t(
        ...
        "Pardesi Pardesi Full Video - Raja Hindustani | Aamir Khan,Karisma Kapoor | Udit Narayan, Alka Yagnik",
        "FAMOUS MUSIC'S",
      ),
      t(
        "T7IZuj5fvYM",
        ...
        "Kumar Sanu",
        "Is Tarah Aashiqui Ka Full Song | Imtihan | Saif Ali Khan, Raveena | Kumar Sanu | 90's Hindi Songs",
        "Tips Official",
      ),
      t(
        "DLYp9GWowYQ",
        ...
        "Is Pyar Se Meri Taraf Na Dekho | Kumar Sanu, Alka Yagnik | Chamatkar | Shah Rukh Khan",
      ...
      t(
        ...
        "Kumar Sanu",
        "Chand Se Parda Kijiye (4K) Video Song | Aao Pyaar Karen | Kumar Sanu | Saif Ali Khan & Shilpa Shetty",
        "Hindi Filmi Songs",
      ),
      t(
        "jO7KrjYBHiY",
        ...
        "Tu Pyar Hai Kisi Aur Ka | Full video in 1080P FULL HD- (Dil Hai Ke Manta Nahin) | Aamir, Pooja",
        "HD MUSIC VIDEOS",
      ),
      t(
        "BMXRic0byxE",
        ...
        "Kishore Kumar",
        "Hamen Tumse Pyar Kitna | Kudrat | Rajesh Khanna,Hema Malini | Kishore Kumar",
      ...
      t(
        ...
        "Dilbar Dilbar",
        "Alka Yagnik",
        "Dilbar Dilbar - Sirf Tum (1999) HD Music Video",
        "Backer .K",
      ),
      t(
        "q_MxDz18l4I",
        "Janu Meri Jaan",
        "Mohammed Rafi, Kishore Kumar, Asha Bhosle, Usha Mangeshkar",
        "Janu Meri Jaan | Shaan | Amitabh Bachchan | Parveen Babi | Kishore Kumar | Mohd Rafi | HD",
        "NH Hindi Songs",
      ),
      t(
        "hD0vuSJxzmc",
        ...
        "Intaha Ho Gai Intezar Ki - Audio | Sharaabi | Amitabh Bachchan, Jaya P, Asha Bhosle, Kishore Kumar",
        "Old Hindi Songs",
      ),
      t(
        "hh7Ps61ws5Q",
        ...
        "Wada Karo Nahin Chodoge Full Song With Lyrics| Kishore Kumar, Lata Mangeshkar| Aa Gale Lag Jaa Songs",
      ...
      t(
        ...
        "Main Tere Pyar Mein Pagal | Lata Mangeshkar, Kishore Kumar | Prem Bandhan 1979 Songs | Rajesh Khanna",
        "Goldmines Gaane Sune Ansune",
      ),
      t(
        "E2WqfG8OBds",
        ...
        "Thodi Si Bekarari 4K Video Song | Chal Mere Bhai | Salman Khan, Karishma Kapoor | Alka Yagnik, Kumar",
        "BollyHD 1080p Music",
      ),
      t(
        "zWPsjhBaRb0",
        ...
        "Humko Humise Chura Lo Song | Mohabbatein | Shah Rukh Khan, Aishwarya Rai | Lata Mangeshkar, Udit N",
        "YRF",
      ),
      t(
        "1cWR8QVhJLE",
        ...
        "Lata Mangeshkar, Udit Narayan",
        "Zinda Rehti Hain Mohabbatein Song | Mohabbatein | Shah Rukh Khan, Aishwarya Rai | Lata Mangeshkar",
        "YRF",
      ),
      t(
        "8cwuAsz5qo4",
        ...
        "Hadh Kardi Aapne - Title Track | Udit Narayan | Kavita Krishnamurthy | Govinda | Rani Mukherjee",
      ...
      t(
        ...
        "O Phirkiwali",
        "Mohammed Rafi",
        "O Phirkiwali 4K Raja Aur Runk (1968) | Mohammed Rafi | Sanjeev Kumar, KumKum",
        "SuperHit Gaane",
      ),
      t(
        "DvU57seTCZI",
        "Teri Galiyon Mein",
        "Mohammed Rafi",
        "Full Video: Teri Galiyon Mein Na Rakhenge Kadam | Hawas (1974) | Neetu Singh,Anil Dhawan | Mohd Rafi",
        "Dard Bhare Gaane",
      ),
      t(
        "e9_Jf2BfrsY",
        ...
        "Mohammed Rafi",
        "Akele Hain Chale Aao (HD) | Raaz (1967) | Rajesh Khanna, Babita | Mohammed Rafi | Old Romantic Songs",
        "Shemaroo Filmi Gaane",
      ),
  ...
  },
  {
    ...
    tracks: [
      t(
        ...
        "Kumar Sanu, Alka Yagnik",
        "Raah Mein Unse Mulaqat Ho Gayi | Ajay Devgn, Tabu | Kumar Sanu, Alka Yagnik | Vijaypath (1994)",
        "Hot Hits Hindi",
      ),
      t(
        "tIALY5lEzfA",
        "Na Kajre Ki Dhar",
        "Pankaj Udhas, Sadhana Sargam",
        "Na Kajre Ki Dhar - Video Song | Mohra | Sunil Shetty | Sadhana Sargam | Pankaj Udhas | 90's Songs",
        "90s Hindi Songs",
      ),
      t(
        "3Z_x7vBqr6E",
        ...
        "Tum Dil Ki Dhadkan Mein - 4K Romantic Video | Dhadkan | Suniel Shetty & Shilpa Shetty",
        "Ishtar Music",
      ),
      t(
        "Xuq6a29AVxM",
        "Baazigar O Baazigar",
        "Kumar Sanu, Alka Yagnik",
        "Baazigar O Baazigar HD Video | Shahrukh Khan , Kajol | Kumar Sanu , Alka Yagnik | 90s Songs",
        "Abhijeet Bharti",
      ),
      t(
        "UxLj89bUflc",
        "Waada Raha Sanam",
        "Abhijeet Bhattacharya, Alka Yagnik",
        "Waada Raha Sanam Lyrical Video Song | Khiladi | Akshay Kumar & Ayesha Jhulka",
        "Ishtar Music",
      ),
      ...
      t(
        ...
        "Alka Yagnik",
        "Tu Shayar Hai Main Teri Shayari | Saajan | Lyrical Video | Alka Yagnik | Sanjay | Madhuri | Salman",
        "Ishtar Music",
      ),
      t(
        "pn8L64hTXB4",
        ...
        "Jo Bhi Kasmein Full Video - Raaz | Bipasha Basu & Dino Morea | Udit Narayan & Alka Yagnik",
        "Best Of Alka Yagnik",
      ),
      t(
        "LvqEcIAsh5k",
        ...
        "Mujhe Neend Na Aaye - Video Song | Udit Narayan, Anuradha Paudwal | Dil | Amir Khan, Madhuri Dixit",
        "T-Series Bollywood Classics",
      ),
      t(
        "IhKXq5dhTag",
        ...
        "Yeh Kaali Kaali Aankhen | Baazigar | Shahrukh Khan & Kajol | HD VIDEO | 90's Song",
        "Ishtar Music",
      ),
      t(
        "rG_ky9Mc_4Q",
        ...
        "Mohabbat Ki Nahi Jati | Udit Narayan | Sadhana Sargam | Hero No.1 | 1997",
        "Gaane Filmi",
      ),
      t(
        "doeVBPCylmg",
        "Kitna Haseen Chehra",
        "Kumar Sanu",
        "Kitna Haseen Chehra [Full Video Song] (HQ) With Lyrics - Dilwale",
        "bollysongs4video",
      ),
      ...
      t(
        ...
        "Teri Umeed Tera Intezaar - Deewana - Rishi Kapoor - Divya Bharti superhit",
        "Gaana Khazana",
      ),
      ...
      t(
        ...
        "Kumar Sanu, Anuradha Paudwal",
        "Tumhein Apna Banane Ki Kasam Khai Hai - Sadak [FHD]",
        "BondTune Hindi",
      ),
      t(
        "9f6GhUb-WdM",
      ...
      t(
        ...
        "Full Video: Hum Yaar Hain Tumhare | Haan Maine Bhi Pyar Kiya | Karisma Kapoor, Abhishek Bachchan",
        "90s Hindi Songs",
      ),
      t(
        "6x_aBA3trGQ",
        ...
        "Udit Narayan",
        "Mubarak Ho Tumko Ye Shadi Tumhari | Udit Narayan | Haan Maine Bhi Pyaar Kiya(2002) | Karisma, Akshay",
        "Shemaroo Filmi Gaane",
      ),
  ...
  },
  {
    ...
    tracks: [
      t(
        "gE3XkDXpB74",
        "Udi Udi Jaye",
        "Sukhwinder Singh, Bhoomi Trivedi, Karsan Sagathia",
        "Udi Udi Jaye - Full Video | Raees | Shah Rukh Khan | Ram Sampath",
        "Zee Music Company",
      ),
      t(
        "fqP5pTPvqZ8",
        "Rangtaari",
        "Dev Negi, Yo Yo Honey Singh",
        "Rangtaari Full Video | Loveyatri | Aayush Sharma | Warina Hussain |Yo Yo Honey Singh |Tanishk Bagchi",
        "T-Series",
      ),
      t(
        "UaHLcQFlhrc",
        "Dandiya Mashup (Param Sundari x Nadiyon Paar)",
        "DJ Lijo",
        "Dandiya Mashup - Param Sundari x Nadiyon Paar | DJ Lijo | Janhvi Kapoor | Kriti Sanon | Roohi | Mimi",
        "Sony Music India",
      ),
      t(
        "ey0ktniv8bs",
        ...
        "Bhammariyo | Shruti Pathak | Divya Kumar | Priya Saraiya | Artiste First",
        "Artiste First",
        2021,
      ),
      t(
        "dh1_OPW9xl8",
        "Jhume Re Gori",
        "Archana Gore, Tarannum Malik Jain, Dipti Rege, Aditi Prabhudesai",
        "Jhume Re Gori | Full Music Video | Gangubai Kathiawadi | Alia Bhatt | Sanjay Leela Bhansali",
        "Saregama Music",
      ),
      t(
        "Z6Fr5hMvjtA",
        "Ghoonghat Mein Chand Hoga",
        "Kumar Sanu, Kavita Krishnamurthy",
        "Ghoonghat Mein Chand Hoga-Khoobsurat 1999 HD Video Song, Sanjay Dutt, Urmila Matondkar",
        "Indian Music HD",
      ),
      t(
        "FyOwgSvKnKU",
      ...
      t(
        "_4fdo3Y5_6g",
        "Chunari Chunari",
        "Abhijeet Bhattacharya, Anuradha Sriram",
        "Aaja Na Chhu Le Meri Chunari Sanam (Chunnari Chunnari) | Biwi No.1 | Abhijeet B | Anuradha",
        "90's Dard - Bollywood Songs",
      ),
      t(
        "h6mK-OJ5YRo",
        "Khallas",
        "Asha Bhosle, Sapna Awasthi, Sudesh Bhosle",
        "Khallas Song Lyrical Video | Company | Ajay Devgan, Ishsha Koppikar, Vivek Oberoi",
        "T-Series Bollywood Classics",
      ),
      ...
      t(
        ...
        "Nayan Video Song | Dhvani B Jubin N | Lijo G Dj Chetas Manoj M Manhar U | Radhika Vinay | Bhushan K",
        "T-Series",
      ),
      t(
        "8zkUFoXku0Y",
      ...
      t(
        ...
        "Teri Aankhon Mein Dikhta Jo Pyaar Mujhe - Full Video Song | Neha Kakkar & Darshan Raval | Divya K",
        "Indian Vibe",
        2020,
      ),
      t(
        ...
        "Kesariya",
        "Arijit Singh",
        "Kesariya - Brahmastra | Ranbir Kapoor, Alia Bhatt | Pritam | Arijit Singh | Amitabh Bhattacharya | 4K",
        "Sony Music India",
        2022,
      ),
      t(
        "uucoiREuIy4",
        "Saawariya",
        "Kumar Sanu, Aastha Gill",
        "Kumar Sanu & Aastha Gill: Saawariya | Arjun Bijlani | Official Video | Latest Dance Song 2021",
        "Sony Music India",
        2021,
      ),
      t(
...
for (const group of groups) {
  ...
  if (new Set(group.tracks.map((track) => track.id)).size !== 25)
    throw new Error(`${group.heading} contains duplicate sources`);
}
...
for (const group of groups)
  for (const track of group.tracks) {
    ...
    if (previous && (previous.title !== track.title || previous.artist !== track.artist))
      throw new Error(`Conflicting metadata for ${track.id}`);
...
const sql = [
  ...
  suppliedTracks
    .map(
      (track) =>
        `  (${quote(`youtube:${track.id}`)}, NULL, ${quote(track.title)}, ${quote(track.artist)}, ${track.year ?? "NULL"}, 'all', 0)`,
    )
    .join(",\n"),
  ...
  suppliedTracks
    .map(
      (track) =>
        `  (${quote(track.id)}, ${quote(track.providerTitle)}, ${quote(track.providerChannel)})`,
    )
    .join(",\n"),
  ...
  [...uniqueTracks.values()]
    .map(
      (track) =>
        `  (${quote(track.id)}, ${quote(track.title)}, ${quote(track.artist)}, ${track.year ?? "NULL"})`,
    )
    .join(",\n"),
...
for (const group of groups) {
  const section = [
    ...
    ...group.tracks.map(
      (track, index) =>
        `${index + 1}. [${track.title} — ${track.artist}](https://www.youtube.com/watch?v=${track.id})`,
    ),
    "",
    "",
  ].join("\n");
  ...
  if (!expression.test(docs))
    throw new Error(`Could not find ${group.heading} documentation section`);
...
console.log(
  JSON.stringify(
    {
      queues: groups.map((group) => [group.heading, group.tracks.length]),
      suppliedValidSources: suppliedTracks.length,
      rejectedSources: invalidIds.length,
    },
    null,
    2,
  ),

...
if (staged.status !== "approved" || stagedChecksum !== staged.sha256)
  throw new Error("Invalid staged catalogue review");
if (sainikChecksum !== sainik.sha256 || sainik.tracks?.length !== 25)
  throw new Error("Invalid Sainik Dhaba review");
...
const clean = {
  "sainik-dhaba": [
    ...
    ["Na Na Na Re", "Daler Mehndi, Sudesh Bhosle"],
    ...
    ["Tutak Tutak Tutian", "Malkit Singh"],
    ["Tera Yaar Bolda", "Surjit Bindrakhia"],
    ["Dupatta Tera Satrang Da", "Surjit Bindrakhia"],
    ["Mukhda Dekh Ke", "Surjit Bindrakhia"],
    ["Mittran Di Chhatri", "Babbu Maan"],
    ["Saun Di Jhadi", "Babbu Maan"],
    ["Challa", "Gurdas Maan"],
    ["Apna Punjab Hove", "Gurdas Maan"],
    ["Dil Da Mamla Hai", "Gurdas Maan"],
    ["Ki Banu Duniya Da", "Gurdas Maan, Diljit Dosanjh"],
    ["Mauja Hi Mauja", "Mika Singh"],
    ["Nagada Nagada", "Sonu Nigam, Javed Ali"],
    ["Aahun Aahun", "Neeraj Shridhar, Master Saleem, Suzi Q"],
    ["Main Jat Yamla Pagla Deewana", "Mohammed Rafi"],
    ["Laung Gawacha", "Neha Bhasin"],
  ],
  "deluxe-salon": [
    ["Chaahat Na Hoti", "Alka Yagnik, Vinod Rathod"],
    ["Tum To Thehre Pardesi", "Altaf Raja"],
    ["Dil Tote Tote Ho Gaya", "Shweta Shetty, Hans Raj Hans"],
    ["Mujhko Rana Ji Maaf Karna", "Ila Arun, Alka Yagnik"],
    ["Dil Laga Liya Maine", "Alka Yagnik, Udit Narayan"],
    ["Kitna Pagal Dil Hai", "Alka Yagnik"],
    ["Utha Le Jaoonga", "Kumar Sanu, Anuradha Paudwal"],
    ["Hum Tumko Nigahon Mein", "Udit Narayan, Shreya Ghoshal"],
    ["Mujhse Mohabbat Ka Izhar", "Alka Yagnik, Kumar Sanu"],
    ["Aap Ke Pyaar Mein", "Alka Yagnik"],
    ["Kyaa Dil Ne Kahaa", "Udit Narayan, Alka Yagnik"],
    ["Tu Pyar Hai Kisi Aur Ka", "Kumar Sanu, Anuradha Paudwal"],
    ["O Yaaron Maaf Karna (Sad Version)", "Kumar Sanu, Alka Yagnik"],
    ["Tu Jo Hans Hans Ke", "Udit Narayan"],
    ["Hum Yaar Hain Tumhare", "Alka Yagnik, Udit Narayan"],
    ["Bepanah Pyar Hai Aaja", "Shreya Ghoshal"],
    ["Sajan Tumse Pyar", "Udit Narayan, Alka Yagnik"],
    ["Ek Din Aap", "Kumar Sanu, Alka Yagnik"],
    ["Dil Ka Kya Kare Saheb", "Kavita Krishnamurthy"],
    ["Sochenge Tumhe Pyar", "Kumar Sanu"],
    ["Rab Kare Tujhko Bhi Pyar Ho Jaye", "Udit Narayan, Alka Yagnik"],
    ["Chand Tare Phool", "Tauseef Akhtar"],
    ["Pehli Pehli Baar Mohabbat Ki Hai", "Kumar Sanu, Alka Yagnik"],
    ["Kisise Tum Pyaar Karo", "Alka Yagnik, Kumar Sanu"],
    ["Pehle Kabhi Na Mera Haal", "Udit Narayan, Alka Yagnik"],
  ],
  "bus-driver": [
    ["Main Nikla Gaddi Leke", "Udit Narayan"],
    ["Long Drive", "Mika Singh"],
    ["Yeh Dosti Hum Nahi Todenge", "Kishore Kumar, Manna Dey"],
    ["Zindagi Ek Safar Hai Suhana", "Kishore Kumar"],
    ["Musafir Hoon Yaron", "Kishore Kumar"],
    ["Chala Jata Hoon", "Kishore Kumar"],
    ["Hum Dono Do Premi", "Lata Mangeshkar, Kishore Kumar"],
    ["Yun Hi Chala Chal", "Udit Narayan, Hariharan, Kailash Kher"],
    ["Aao Milo Chalen", "Shaan, Ustad Sultan Khan"],
    ["Ilahi", "Arijit Singh"],
    ["Safarnama", "Lucky Ali"],
    ["Phir Se Ud Chala", "Mohit Chauhan"],
    ["Patakha Guddi", "Nooran Sisters"],
    ["Khaabon Ke Parinday", "Alyssa Mendonsa, Mohit Chauhan"],
    ["Journey Song", "Anupam Roy, Shreya Ghoshal"],
    ["Dil Chahta Hai", "Shankar Mahadevan"],
    ["Hairat", "Lucky Ali"],
    ["Roobaroo", "A. R. Rahman, Naresh Iyer"],
    ["Banjarey", "Yo Yo Honey Singh"],
    [
      "Ik Junoon (Paint It Red)",
      "Vishal Dadlani, Alyssa Mendonsa, Gulraj Singh, Shankar Mahadevan",
    ],
    ["Dekha Hai Aise Bhi", "Lucky Ali"],
    ["Tanha Dil", "Shaan"],
    ["Gaddi Jaandi Ae Chalaangaan Maardi", "Ammy Virk"],
    ["Hornn Blow", "Harrdy Sandhu"],
    ["Born to Shine", "Diljit Dosanjh"],
  ],
  "bartan-time": [
    ["Teri Aankhon Mein", "Darshan Raval, Neha Kakkar"],
    ["Show Me the Thumka", "Sunidhi Chauhan, Shashwat Singh"],
    ["Teri Baaton Mein Aisa Uljha Jiya", "Raghav, Tanishk Bagchi, Asees Kaur"],
    ...
    ["Nayan", "Dhvani Bhanushali, Jubin Nautiyal"],
    ["Wedding Mashup 2023", "VDJ Ayush, Mihir"],
    ["Laal Peeli Akhiyaan", "Romy"],
    ["Bachke Tu Rehna (Khallas Remix)", "DJ SR"],
    ["Raataan Lambiyan", "Jubin Nautiyal, Asees Kaur"],
    ["Stay", "Rihanna, Mikky Ekko"],
    ["We Found Love", "Rihanna, Calvin Harris"],
    ["Kurchi Madathapetti Megamix", "Sush & Yohan"],
    ["Bollywood Navratri Mashup 2023", "Musical Trip"],
    ["Bollywood Dandiya 2023", "Musical Trip"],
    ["Suniyan Suniyan", "Juss"],
    ["Gulabi Sadi", "Sanju Rathod, G-SPXRK"],
    ["Taaron Ke Shehar", "Neha Kakkar, Jubin Nautiyal"],
    ["Pyaar Hota Kayi Baar Hai", "Arijit Singh"],
    ["Diamonds", "Rihanna"],
    ["Dekhha Tenu", "Mohammad Faiz"],
  ],
  "raju-mistri": [
    ["Tu Pyar Hai Kisi Aur Ka", "Kumar Sanu, Anuradha Paudwal"],
    ["Sochenge Tumhe Pyar", "Kumar Sanu"],
    ["Aye Mere Humsafar", "Udit Narayan, Alka Yagnik"],
    ["Woh Ladki Bohot Yaad Aati Hai", "Kumar Sanu, Alka Yagnik"],
    ["Kitna Haseen Chehra", "Kumar Sanu"],
    ["Hum Yaar Hai Tumhare", "Alka Yagnik, Udit Narayan"],
    ["Abhi To Mohabbat Ka", "Udit Narayan, Alka Yagnik"],
    ["Teri Umeed Tera Intezar", "Kumar Sanu"],
    ["Mujhse Mohabbat Ka Izhar", "Alka Yagnik, Kumar Sanu"],
    ["Tumsa Koi Pyaara", "Kumar Sanu, Alka Yagnik"],
    ["Raah Mein Unse Mulaqat", "Kumar Sanu, Alka Yagnik"],
    ["Dil Cheer Ke Dekh", "Kumar Sanu"],
    ["Is Pyar Se Meri Taraf Na Dekho", "Kumar Sanu"],
    ["Chaaha Toh Bahut", "Kumar Sanu, Bela Sulakhe"],
    ["Pucho Zara Pucho", "Alka Yagnik, Kumar Sanu"],
    ["Tumse Milne Ki Tamanna Hai", "S. P. Balasubrahmanyam"],
    ["Too Shayar Hai Main Teri Shayari", "Alka Yagnik"],
    ["Lagi Aaj Sawan Ki", "Anupama Deshpande, Suresh Wadkar"],
    ["Chhupana Bhi Nahi Aata", "Vinod Rathod"],
    ["Kitaben Bahut Si", "Asha Bhosle, Vinod Rathod"],
    ["Baazigar O Baazigar", "Kumar Sanu, Alka Yagnik"],
    ["Koi Na Koi Chahiye", "Vinod Rathod"],
    ["Jeeta Tha Jiske Liye", "Kumar Sanu, Alka Yagnik"],
    ["Tumhein Apna Banane Ki Kasam", "Kumar Sanu, Anuradha Paudwal"],
  ...
  "papa-ke-gaane": [
    ...
    ["Ankhiyon Ke Jharokhon Se", "Hemlata"],
    ["Dekha Ek Khwab", "Lata Mangeshkar, Kishore Kumar"],
    ["Inteha Ho Gai", "Kishore Kumar, Asha Bhosle"],
    ...
    ["Tumne Kisi Se Kabhi Pyar Kiya Hai", "Mukesh, Kanchan"],
    ["Hamen Tumse Pyar Kitna", "Kishore Kumar"],
    ["Wada Karo", "Kishore Kumar, Lata Mangeshkar"],
    ["Neele Neele Ambar Par", "Kishore Kumar"],
    ["Salam-E-Ishq Meri Jaan", "Lata Mangeshkar, Kishore Kumar"],
  ...
  "corporate-majdoor": [
    ...
    ["Tu Banja Gali Benaras Ki", "Asit Tripathy"],
    ...
    ["Dooron Dooron (Unplugged)", "Paresh Pahuja"],
    ["Afreen Afreen", "Rahat Fateh Ali Khan, Momina Mustehsan"],
    ["Raataan Lambiyan", "Jubin Nautiyal, Asees Kaur"],
    ["Tu Jaane Na", "Atif Aslam"],
    ["Saiyyan", "Kailash Kher"],
    ["Hawayein", "Arijit Singh"],
    ["Bahara", "Shreya Ghoshal, Sona Mohapatra"],
    ["Dil Mein Ho Tum", "Armaan Malik"],
    ["Tu Hi Haqeeqat", "Javed Ali, Irshan Ashraf, Shadab"],
    ["Kinna Sona", "Sunil Kamath"],
    ["Subhanallah", "Sreeram, Shilpa Rao"],
    ["Saiyaara", "Mohit Chauhan, Taraannum Mallik"],
  ],
};
...
const groups = [
  {
    ...
    tracks: sainik.tracks,
  },
  ...[
    ["deluxe-salon", "Deluxe Salon", "nai-ki-dukaan"],
    ["bus-driver", "Bus Driver", "bus-driver"],
    ["bartan-time", "Bartan Time", "bartan-time"],
    ["raju-mistri", "Raju Mistri", "raj-mistri"],
    ["papa-ke-gaane", "Papa Ke Gaane", "papa-ke-gaane"],
    ["corporate-majdoor", "Corporate Majdoor", "corporate-majdoor"],
  ].map(([slug, displayName, sceneSlug]) => ({
    slug,
    displayName,
    sceneSlug,
    tracks: stagedGroups.get(slug)?.tracks,
  })),
];
for (const group of groups) {
  if (group.tracks?.length !== 25 || clean[group.slug]?.length !== 25)
    throw new Error(`Expected 25 tracks for ${group.slug}`);
  group.tracks = group.tracks.map((track, index) => ({
    ...track,
    title: clean[group.slug][index][0],
    artist: clean[group.slug][index][1],
    position: index + 1,
  }));
}
...
for (const group of groups)
  for (const track of group.tracks) {
    ...
    if (prior && (prior.title !== track.title || prior.artist !== track.artist))
      throw new Error(`Conflicting cleanup for ${track.videoId}`);
    unique.set(track.videoId, track);
  }
if (groups.reduce((sum, group) => sum + group.tracks.length, 0) !== 175 || unique.size !== 171)
  throw new Error("Expected 175 memberships and 171 unique videos");
...
const scenes = [
  {
    ...
    en: "Bus Driver",
    hi: "बस ड्राइवर",
    hook: "Lambi route, khuli sadak, aur dashboard ka purana radio.",
    description:
      "An overnight intercity bus cabin: humming engine, glowing highway signs and songs keeping the driver awake.",
    palette: { cool: "#17232D", accent: "#E5A100", accent2: "#C1440E" },
    dark: true,
    gag: "Horn do",
    order: 3,
    tags: ["safar", "shaam"],
    lines: [
      ["Agla stop chai aur diesel ke baad.", "अगला स्टॉप चाय और डीज़ल के बाद।", "all"],
      [
        "Conductor ne phir se aadhi neend mein seeti bajayi.",
        "कंडक्टर ने फिर आधी नींद में सीटी बजाई।",
        "night",
      ],
      ["High beam kam rakho, raat lambi hai.", "हाई बीम कम रखो, रात लंबी है।", "night"],
      [
        "Dashboard ka radio signal pakad raha hai.",
        "डैशबोर्ड का रेडियो सिग्नल पकड़ रहा है।",
        "all",
      ],
      [
        "Peechhe wali seat par koi abhi tak soya nahi.",
        "पीछे वाली सीट पर कोई अभी तक सोया नहीं।",
        "night",
      ],
    ],
  },
  {
    ...
    en: "Bartan Time",
    hi: "बर्तन टाइम",
    hook: "Steel ki khanak, nal ka paani, aur kitchen ka radio.",
    description:
      "A late-night Indian kitchen after dinner: stacked steel plates, running water and songs between every scrub.",
    palette: { cool: "#183A3A", accent: "#E5A100", accent2: "#6B7B53" },
    dark: true,
    gag: "Ek aur plate",
    order: 4,
    tags: ["kaam", "yaadein"],
    lines: [
      ["Bas ye patila reh gaya... aur teen katori.", "बस ये पतीला रह गया... और तीन कटोरी।", "all"],
      [
        "Jhaag zyada ho toh kaam thoda kam lagta hai.",
        "झाग ज़्यादा हो तो काम थोड़ा कम लगता है।",
        "all",
      ],
      ["Steel ka bartan apna hi taal banata hai.", "स्टील का बर्तन अपनी ही ताल बनाता है।", "all"],
      [
        "Sab kha ke chale gaye; radio abhi bhi yahin hai.",
        "सब खाकर चले गए; रेडियो अभी भी यहीं है।",
        "night",
      ],
      ["Kal se turant dho denge — pakka.", "कल से तुरंत धो देंगे — पक्का।", "night"],
    ],
  },
  {
    slug: "papa-ke-gaane",
    en: "Papa Ke Gaane",
    hi: "पापा के गाने",
    hook: "Sunday ki safai, purani cassette, aur Papa ki pakki playlist.",
    description:
      "A familiar family room on a slow Sunday: newspapers, old speakers and the songs Papa never skips.",
    palette: { cool: "#4A3827", accent: "#E5A100", accent2: "#6B7B53" },
    dark: false,
    gag: "Volume badhao",
    order: 6,
    tags: ["shaam", "yaadein"],
    lines: [
      [
        "Is gaane ke time tum paida bhi nahi hue the.",
        "इस गाने के समय तुम पैदा भी नहीं हुए थे।",
        "all",
      ],
      [
        "Cassette ko pencil se rewind karna padta tha.",
        "कैसेट को पेंसिल से रिवाइंड करना पड़ता था।",
        "all",
      ],
      ["Sunday ka akhbaar aur side A.", "रविवार का अख़बार और साइड ए।", "morning"],
      [
        "Singer ka naam poochho, Papa ko sab yaad hai.",
        "गायक का नाम पूछो, पापा को सब याद है।",
        "all",
      ],
      [
        "Remote nahi milega; volume wahi rahega.",
        "रिमोट नहीं मिलेगा; आवाज़ वहीं रहेगी।",
        "evening",
      ],
    ],
  },
...
const lines = [
  ...
  `-- Source checksums: staged=${staged.sha256}; sainik=${sainik.sha256}`,
  "BEGIN;",
...
lines.push(
  ...
  scenes
    .map(
      (s) =>
        `  (${quote(s.slug)}, ${quote(s.en)}, ${quote(s.hi)}, ${quote(s.hook)}, ${quote(s.description)}, 'Pan India', 'tier1', ${quote(JSON.stringify(s.palette))}::jsonb, ${quote(s.slug)}, ${s.dark}, false, 'closed', ${quote(s.gag)}, ${s.order}, ARRAY[${s.tags.map(quote).join(", ")}]::text[])`,
    )
    .join(",\n"),
...
for (const scene of scenes)
  for (const [en, hi, daypart] of scene.lines)
    lines.push(
      `INSERT INTO public.oneliners(scene_id, text_en, text_hi, daypart_tag) SELECT s.id, ${quote(en)}, ${quote(hi)}, ${quote(daypart)} FROM public.scenes s WHERE s.slug=${quote(scene.slug)} AND NOT EXISTS (SELECT 1 FROM public.oneliners o WHERE o.scene_id=s.id AND o.text_en=${quote(en)});`,
    );
...
lines.push(
  ...
  allRows
    .filter(([id]) => sainik.tracks.some((track) => track.videoId === id))
    .map(
      ([id, track]) =>
        `  (${quote(`youtube:${id}`)}, NULL, ${quote(track.title)}, ${quote(track.artist)}, ${track.year == null ? "NULL" : Number(track.year)}, 'all', 0)`,
    )
    .join(",\n"),
  ...
  sainik.tracks
    .map(
      (track) =>
        `  (${quote(track.videoId)}, ${quote(track.providerTitle)}, ${quote(track.providerChannel)}, ${quote(track.validatedAt)})`,
    )
    .join(",\n"),
...
lines.push(
  ...
  allRows
    .map(
      ([id, track]) =>
        `  (${quote(id)}, ${quote(track.title)}, ${quote(track.artist)}, ${track.year == null ? "NULL" : Number(track.year)})`,
    )
    .join(",\n"),
...
lines.push(
  ...
  setDefs
    .map(
      ([slug, title, order, origin]) =>
        `  (${quote(slug)}, ${quote(title)}, ${order}, ${quote(origin)})`,
    )
    .join(",\n"),
...
lines.push(
  ...
  sainikGroup.tracks.map((track) => `  (${quote(track.videoId)}, ${track.position})`).join(",\n"),
...
const docs = [
  ...
  ...groups.flatMap((group) => [
    ...
    ...group.tracks.map(
      (track) =>
        `${track.position}. [${track.title} — ${track.artist}](https://www.youtube.com/watch?v=${track.videoId})`,
    ),
    "",
  ]),
];
...
console.log(
  JSON.stringify(
    { stagedChecksum, sainikChecksum, memberships: 175, uniqueVideos: unique.size },
    null,
    2,
  ),
);
